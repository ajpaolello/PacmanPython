...
def game():
    ...
    #munch = pygame.mixer.Sound("audio/munch.wav")
    munch = {}
    munch[0] = pygame.mixer.Sound("audio/munch_1.wav")
    munch[1] = pygame.mixer.Sound("audio/munch_2.wav")
    munchnum = 0
    ...
    lifeIcon = pygame.image.load("img/PacManMinRight.png")
    ...
    while not done:
        ...
        #Choose font
        #Create 3 texts, 1 is score, 2 is game over, and 3 is win
        font = pygame.font.SysFont('comicsansms', 25, True, False)
        scoreLabel = font.render("HIGH SCORE", True, (255, 255, 255))
        highScore = font.render(str(highscore), True, (255, 255, 255))
        oneUpLabel = font.render("1UP", True, (255, 255, 255))
        scoreText = font.render(str(score), True, 
                (255, 255, 255))
        ...
        #Check collison between pacman and pellets, 
        #remove pellet if collides.
        #Also if collide, play sound and increase score by 1
        ...
        screen.blit(scoreLabel, [250, 30])
        screen.blit(highScore, [280, 60])
        screen.blit(oneUpLabel, [44, 30])
        screen.blit(scoreText, [55, 60])

        for life in range(lives):
            screen.blit(lifeIcon, [10+(life*30), 770])
...
def menu():
    ...
    titleFont = pygame.font.SysFont('comicsansm', 100, True, False)
    titleText = titleFont.render("Pac-Man", True, (255, 255, 255))
    enterText = font.render("Press ENTER to play", True, (255, 255, 255))
    quitText = font.render("Press Q to quit", True, (255, 255, 255))

    menuImage = pygame.image.load('img/titleGraphic_scaled.jpg').convert()
    
    screen.blit(titleText, (138, 150))
    screen.blit(menuImage, (0, 300))
    screen.blit(enterText, (150, 600))
    screen.blit(quitText, (170, 650))
...
def makeWalls():
    ...
    right_t_bottom, right_t_left_lower_horizontal, right_t_left_lower_vertical, right_t_left_upper_horizontal,
    ...
    lower_middle_t_bottom, lower_middle_t_left_horizontal, lower_middle_t_lower_left, lower_middle_t_lower_right,
    lower_middle_t_right_horizontal, lower_middle_t_top, lower_middle_t_upper_left, lower_middle_t_upper_right,
    bottom_middle_t_bottom, bottom_middle_t_left_horizontal, bottom_middle_t_lower_left, bottom_middle_t_lower_right,
    bottom_middle_t_right_horizontal, bottom_middle_t_top, bottom_middle_t_upper_left, bottom_middle_t_upper_right,
    left_horizontal_box_bottom, left_horizontal_box_left, left_horizontal_box_right, left_horizontal_box_top,
    right_horizontal_box_bottom, right_horizontal_box_left, right_horizontal_box_right, right_horizontal_box_top,
    left_upside_down_l_bottom, left_upside_down_l_left_horizontal, left_upside_down_l_lower_left, left_upside_down_l_right,
    left_upside_down_l_top, left_upside_down_l_upper_left, right_upside_down_l_bottom, right_upside_down_l_left,
    right_upside_down_l_lower_right, right_upside_down_l_right_horizontal, right_upside_down_l_top, right_upside_down_l_upper_right,
    left_wall_box_bottom, left_wall_box_right, left_wall_box_top, right_wall_box_bottom, right_wall_box_left, right_wall_box_top,
    left_upside_down_t_bottom, left_upside_down_t_left_horizontal, left_upside_down_t_lower_left, left_upside_down_t_lower_right,
    left_upside_down_t_right_horizontal, left_upside_down_t_top, left_upside_down_t_upper_left, left_upside_down_t_upper_right,
    right_upside_down_t_bottom, right_upside_down_t_left_horizontal, right_upside_down_t_lower_left, right_upside_down_t_lower_right,
    right_upside_down_t_right_horizontal, right_upside_down_t_top, right_upside_down_t_upper_left, right_upside_down_t_upper_right,
    ghost_cage_bottom, ghost_cage_horizontal_left, ghost_cage_horizontal_right, ghost_cage_vertical_left, ghost_cage_vertical_right]
...
def gameover():
    ...
    loseFont = pygame.font.SysFont('comicsansm', 25, True, False)
    loseText = loseFont.render("Game Over!", True, (255, 255, 255))
    gameoverText = font.render("Play again? (Y/N)", True, (255, 255, 255))
    
    screen.blit(loseText, (248, 330))
    screen.blit(gameoverText, (248, 355))
...
#Set screen size and make it fullscreen. 
